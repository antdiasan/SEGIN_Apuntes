...
- **LDAP (Lightweight Directory Access Protocol):**  
  ...
  Se puede entender como un **almacén gigante de usuarios**.
...
- **RADIUS (Remote Authentication Dial-In User Service):**  
  ...
  Su símil podría ser **el portero** que comprueba en el almacén quien eres.
...
- **Kerberos:**  
  ...
  Su símil sería el **emisor de carnets** que te da un ticket para acceder a servicios sin volver a iniciar sesión.
